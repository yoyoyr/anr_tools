package com.asm.plugin.privacymethod
...
class AsmItem(
    ...
    override fun toString(): String {
        return "    AsmItem(oriClass=$oriClass, oriMethod=$oriMethod, oriDesc=$oriDesc, oriAccess=$oriAccess,\n" +
                "targetClass='$targetClass', targetMethod='$targetMethod', targetDesc='$targetDesc', targetAccess=$targetAccess)"
    }


}

fun AsmItem.toMethodNode() = MethodInsnNode(targetAccess, targetClass, targetMethod, targetDesc)